...
* ```docker run -v a:a -v ${PWD}/b:b some_image``` mounts the a directory on the host to the a directory in the container and the b directory in the current working directory on the host to the b directory in the container.
